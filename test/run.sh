...
gcc -Wall -Werror -Wextra -g -fsanitize=address -include libft.h test/main_strchr.c		libft.a -o test/a.out && ./test/a.out && rm test/a.out
...
gcc -Wall -Werror -Wextra -g -fsanitize=address -include libft.h test/main_strjoin.c	libft.a -o test/a.out && ./test/a.out && rm test/a.out
